...
public class TimeEntryControllerTest {
  ...
  @Test public void testCreate() throws Exception {
    ...
    verify(counter).increment("TimeEntry.created");
  ...
  @Test public void testRead() throws Exception {
    ...
    verify(counter).increment("TimeEntry.read");
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(expected);
  }

  @Test public void testRead_NotFound() throws Exception {
    doReturn(null).when(timeEntryRepository).find(1L);
  ...
  @Test public void testList() throws Exception {
    List<TimeEntry> expected =
        asList(new TimeEntry(1L, 123L, 456L, LocalDate.parse("2017-01-08"), 8),
    ...
    verify(counter).increment("TimeEntry.listed");
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(expected);
  }
  ...
  @Test public void testUpdate() throws Exception {
    ...
    verify(counter).increment("TimeEntry.updated");
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(expected);
  }

  @Test public void testUpdate_NotFound() throws Exception {
    doReturn(null).when(timeEntryRepository).update(eq(1L), any(TimeEntry.class));
  ...
  @Test public void testDelete() throws Exception {
    ...
    verify(counter).increment("TimeEntry.deleted");
    verify(gauge).submit(eq("timeEntries.count"), anyInt());
